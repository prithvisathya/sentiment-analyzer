...
class Zappa:
    ...
    def get_installed_packages(
        ...
        for package in importlib.metadata.distributions():  # returns PathDistribution objects
            ...
            if getattr(package, 'name', None) and package.name.lower() in packages_to_keep or package_installed_directory in additional_install_locations:
                if getattr(package, 'name', None): installed_packages[package.name.lower()] = package.version
